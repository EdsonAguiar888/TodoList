 ...
 * @author HP
 */
public class MainScreean extends javax.swing.JFrame {

    ProjectController projectController;
    TaskController taskController;
    
    DefaultListModel projectsModel;  //Lista onde sera salvo dados vindos do sgbd
    ...
    public MainScreean(){
        ...
        decorateTableTask();  // chamando o metodo decorate
    }
    ...
    private void initComponents() {
        ...
        jLabelToolBarSubTitle.setText("Anote tudo, não esqueça!!!");
        ...
        jLabelEmptyListSubTitle.setText("Clique no botao '+' para adicionar ");
        ...
        jLabelEmptyListIcon.setAlignmentY(0.1F);
    ...
    private void jLabelProjectsAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelProjectsAddMouseClicked
        ...
        // Fica ouvindo a janela de adicionar novo projeto ser fechada e carrega os projetos.
    ...
    private void jLabelTasksAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelTasksAddMouseClicked
        ...
        Project project = (Project) projectsModel.get(projectIndex); // seleciona o projeto pelo index de onde foi clicado.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainScreean.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainScreean().setVisible(true);
            }
        });
    }
    ...
    public void decorateTableTask(){
        ...
        //Criando um sort(organizador ordem alfabetica) para as colunas da table
